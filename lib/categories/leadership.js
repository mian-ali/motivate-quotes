const leadershipQuotes = [
    ...
    {
      text: "The challenge of leadership is to be strong, but not rude; be kind, but not weak; be bold, but not a bully; be thoughtful, but not lazy; be humble, but not timid; be proud, but not arrogant; have humor, but without folly.",
      author: "Jim Rohn"
    },
    {
    ...
    },
    {
      ...
      author: "Reverend Theodore M. Hesburgh"
    },
    {
    ...
    {
      text: "Leadership is the capacity and will to rally men and women to a common purpose and the character which inspires confidence.",
...
module.exports = leadershipQuotes;
