const creativityQuotes = 
  [
    ...
    {
      text: "Creativity is seeing what everyone else has seen, and thinking what no one else has thought.",
      author: "Albert Einstein"
    },
    {
    ...
    {
      text: "The most talented, thought-provoking, game-changing people are never normal.",
...
module.exports = creativityQuotes;
